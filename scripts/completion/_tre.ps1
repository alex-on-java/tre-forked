...
Register-ArgumentCompleter -Native -CommandName 'tre' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'tre' {
            ...
            [CompletionResult]::new('-n', 'n', [CompletionResultType]::ParameterName, 'Limit total number of lines in output (smart allocation)')
            [CompletionResult]::new('--lines', 'lines', [CompletionResultType]::ParameterName, 'Limit total number of lines in output (smart allocation)')
